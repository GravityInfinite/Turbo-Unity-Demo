...
@implementation GESecretKey


- (instancetype)initWithVersion:(NSUInteger)version
                      publicKey:(NSString *)publicKey {
    
    return [[GESecretKey alloc] initWithVersion:version
                                      publicKey:publicKey
...
- (id)copyWithZone:(NSZone *)zone {
    GESecretKey *secretKey = [[[self class] allocWithZone:zone] init];
