...
本文档为**Unity**接入 [turbo 引力引擎](https://gravity-engine.com/)的技术接入方案，具体 Demo 请参考[GitHub](https://github.com/GravityInfinite/Turbo-Unity-Demo)或者[Gitee](https://gitee.com/GravityInfinite/Turbo-Unity-Demo)开源项目（国内用户推荐 Gitee），Demo 工程中可以参考 TurboScript 中对方法的调用示例。

#### SDK 引入

去上述开源代码仓库中下载 `turbo.unitypackage`文件并将`GravityTurbo`文件夹中的代码引入到工程中。
